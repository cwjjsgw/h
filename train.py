...
tf.flags.DEFINE_string('X', 'apple.tfrecords',
                       'X tfrecords file for training, default: apple.tfrecords')
tf.flags.DEFINE_string('Y', 'orange.tfrecords',
                       'Y tfrecords file for training, default: orange.tfrecords')
